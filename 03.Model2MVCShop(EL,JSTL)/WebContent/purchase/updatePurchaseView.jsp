...
<table width="600" border="0" cellspacing="0" cellpadding="0"	align="center" style="margin-top: 13px;">
	...
	<tr>
		...
		<input type="hidden" name="trancCode" value="${vo.tranCode }">
	...
	<tr>
		...
		<td class="ct_write01">
			<select 	name="paymentOption" 	class="ct_input_g" style="width: 100px; height: 19px" 
				...
				<option value="1" ${vo.paymentOption=='1' ?"selected":"" }>현금구매</option>
				<option value="2" ${vo.paymentOption=='2' ?"selected":"" }>신용구매</option>
			</select>
		</td>
	</tr>
	<tr>
